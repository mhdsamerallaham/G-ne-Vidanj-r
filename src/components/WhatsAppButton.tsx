...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Sayfa yüklenince 2 saniye sonra göster
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-2xl shadow-orange-500/40 transition-all hover:scale-110 group"
        title="Hemen Ara"
      >
        <svg
          className="h-6 w-6"
      ...
      <div className="relative">
        ...
        <a
          href="https://wa.me/905335817936?text=Merhaba%2C%20vidanj%C3%B6r%20hizmeti%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
          target="_blank"
          rel="noopener noreferrer"
          className="relative flex items-center justify-center w-16 h-16 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl shadow-green-500/40 transition-all hover:scale-110"
