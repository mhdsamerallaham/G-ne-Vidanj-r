...
export const metadata: Metadata = {
  title: "Döşeme Vidanjör - 7/24 Tıkalı Gider Açma | Güneş Tıkanıklık",
  description: "Döşeme'de vidanjör, tıkalı gider açma, kanalizasyon temizleme ve logar boşaltma hizmetleri. 7/24 acil müdahale, uygun fiyat.",
};
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-8">
          Döşeme Vidanjör Hizmeti
        </h1>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold mb-4">Döşeme Hizmetlerimiz</h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-6">
            Döşeme'nin tüm mahallelerinde acil vidanjör hizmeti vermekteyiz.
