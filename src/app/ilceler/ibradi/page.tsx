...
export const metadata: Metadata = {
  title: "İbradı Vidanjör - 7/24 Tıkalı Gider Açma | Güneş Tıkanıklık",
  description: "İbradı'da vidanjör, tıkalı gider açma, kanalizasyon temizleme ve logar boşaltma hizmetleri. 7/24 acil müdahale, uygun fiyat.",
};

export default function IbradiPage() {
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-8">
          İbradı Vidanjör Hizmeti
        </h1>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold mb-4">İbradı Hizmetlerimiz</h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-6">
            İbradı'nın tüm mahallelerinde acil vidanjör hizmeti vermekteyiz.
