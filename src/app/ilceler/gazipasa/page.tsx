...
export const metadata: Metadata = {
  title: "Gazipaşa Vidanjör - 7/24 Tıkalı Gider Açma | Güneş Tıkanıklık",
  description: "Gazipaşa'da vidanjör, tıkalı gider açma, kanalizasyon temizleme ve logar boşaltma hizmetleri. 7/24 acil müdahale, uygun fiyat.",
};

export default function GazipasaPage() {
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-8">
          Gazipaşa Vidanjör Hizmeti
        </h1>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold mb-4">Gazipaşa Hizmetlerimiz</h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-6">
            Gazipaşa'nın tüm mahallelerinde acil vidanjör hizmeti vermekteyiz.
