...
export const metadata: Metadata = {
  title: "Aksu Vidanjör - 7/24 Tıkalı Gider Açma | Güneş Tıkanıklık",
  description: "Aksu'da vidanjör, tıkalı gider açma, kanalizasyon temizleme ve logar boşaltma hizmetleri. 7/24 acil müdahale, uygun fiyat.",
};
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-8">
          Aksu Vidanjör Hizmeti
        </h1>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold mb-4">Aksu Hizmetlerimiz</h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-6">
            Aksu'nun tüm mahallelerinde acil vidanjör hizmeti vermekteyiz.
