...
export const metadata: Metadata = {
  title: "Gündoğmuş Vidanjör - 7/24 Tıkalı Gider Açma | Güneş Tıkanıklık",
  description: "Gündoğmuş'ta vidanjör, tıkalı gider açma, kanalizasyon temizleme ve logar boşaltma hizmetleri. 7/24 acil müdahale, uygun fiyat.",
};

export default function GundogmusPage() {
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-8">
          Gündoğmuş Vidanjör Hizmeti
        </h1>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold mb-4">Gündoğmuş Hizmetlerimiz</h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-6">
            Gündoğmuş'un tüm mahallelerinde acil vidanjör hizmeti vermekteyiz.
